...
export default function Feature({ src, title, description }: FeatureProps) {
  return (
    <article className="relative w-full max-w-4xl h-67.5 rounded-xl overflow-hidden shadow-lg group cursor-pointer border border-accent/20">
      <div className="absolute -z-10 inset-0 will-change-transform transition-transform duration-300 group-hover:scale-105">
        <Image
          ...
          fill={true}
          priority
          sizes="(max-width: 896px) 100vw, (max-height: 270px) 100vw"
